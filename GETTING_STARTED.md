...
### 1. Clone and Build WT

The WT library is already included in the `wt/` directory:

```bash
# Run the setup script to install dependencies and build WT
./setup.sh
```
...
cmake ..
make
./BasicWtApp --http-port=8080 --docroot=..
...
cmake ..
make
./CustomWidgetDemo --http-port=8081 --docroot=..
```
...
- **[examples/](examples/)** - Working code examples
  - `basic_app/` - Simple hello world application
  - `custom_widgets/` - Advanced custom widget examples

## Key Concepts for Copilot

When working with the WT library, here are the essential patterns you should know:
